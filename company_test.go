...
func TestCompanyListUsersByID(t *testing.T) {
	companyContactsList, _ := (&CompanyService{Repository: TestCompanyAPI{t: t}}).ListContactsByID("46adad3f09126dca", PageParams{})
	contacts := companyContactsList.Contacts
...
func TestCompanyListUsersByCompanyID(t *testing.T) {
	companyContactsList, _ := (&CompanyService{Repository: TestCompanyAPI{t: t}}).ListContactsByCompanyID("134d", PageParams{})
	contacts := companyContactsList.Contacts
